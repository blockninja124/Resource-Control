...
public class ResourceUtils {
	...
	public static boolean isOnServer() {
		throw new AssertionError("platform not implemented");
	}
	...
	private static void log(String message, int level) {
		...
		if (!isOnServer()) {
			...
			NetworkHandler.sendRCPacketToServer(new LogToServerPacket(message, level));
		} else {
	 ...
	 */
	public static int movePack(String packId, int amount, boolean reload) {
		try {
	 ...
	 * @see #movePackDown
	 */
	public static int movePackUp(String packId, int amount, boolean reload) {
	 ...
	 * @see #movePackUp
	 */
	public static int movePackDown(String packId, int amount, boolean reload) {
